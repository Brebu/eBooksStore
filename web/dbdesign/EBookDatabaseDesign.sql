...
ID_GENRE integer,
PRICE numeric(10,2)
--,FOREIGN KEY(id_type) REFERENCES EBOOKS.BOOK_TYPES(ID),
--FOREIGN KEY(ID_QUALITY) REFERENCES EBOOKS.BOOK_PAPER_QUALITIES(ID),
--FOREIGN KEY(ID_GENRE) REFERENCES EBOOKS.BOOK_GENRES(ID)
);
...
--FOREIGN KEY(ID_SSN) REFERENCES EBOOKS.BOOK_AUTHOR(SSN)
);
...
ID_SSN varchar(13),
ID_ISBN varchar(50)
--,FOREIGN KEY(ID_RATING) REFERENCES EBOOKS.RATINGS(ID),
...
-----------------------
insert into EBOOKS.EBOOKS(ISBN, TITLE, PRICE, ID_TYPE, ID_QUALITY, PAGES, ID_GENRE)
